...
// NEW API to retrieve all the public films that the logged-in user has been invited to review, without pagination.
app.get('/api/films/public/all', isLoggedIn, filmController.getAllInvitedFilms); 
...
// Modified the update of a single review API
